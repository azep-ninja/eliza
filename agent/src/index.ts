...
import { TwitterClientInterfaceQi } from "@elizaos/client-twitter-qi";
...
export async function initializeClients(
    ...
    if (clientTypes.includes(Clients.TWITTERQI)) {
        const twitterClientQi = await TwitterClientInterfaceQi.start(runtime);
        if (twitterClientQi) {
            clients.twitterqi = twitterClientQi;
        }
    }
